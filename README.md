# sanity-gatsby-portfolio-starter
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/ahkvw8qj/settings/api) and create a token with read rights.
